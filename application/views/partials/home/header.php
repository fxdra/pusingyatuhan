                        ...
                        <div class="row">
                            ...
                            <div class="logo col-4 col-sm-4 col-md-4 col-lg-2 align-self-center">
                                <a class="logoImg" href="/">
                                    <img class="mx-lg-auto default-logo" src="/assets/images/logo-white.png" alt="Hema Multipurpose Html Template" title="Hema Multipurpose Html Template" width="149" height="39" />
                            ...
                            <div class="col-8 col-sm-8 col-md-8 col-lg-5 align-self-center icons-col text-right">
                                ...
                                <div class="header-cart iconset" title="Cart">
                                    <a href="#;" class="header-cart btn-minicart clr-none" data-bs-toggle="offcanvas" data-bs-target="#minicart-drawer"><i class="hdr-icon icon anm anm-basket-l"></i><span class="cart-count">100</span></a>
                                </div>
                                <!--End Minicart-->
                                <!--Mobile Toggle-->
