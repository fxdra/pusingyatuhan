                        ...
                        <ul class="m-0 clearfix">
                            <li class="item d-flex justify-content-center align-items-center">
                                <a class="product-image" href="product-layout1.html">
                                    <img class="blur-up lazyload" data-src="/assets/images/products/cart-electronic-product-img1.jpg" src="/assets/images/products/cart-electronic-product-img1.jpg" alt="product" title="Product" width="120" height="170" />
                                </a>
                            ...
                            <li class="item d-flex justify-content-center align-items-center">
                                <a class="product-image" href="product-layout1.html">
                                    <img class="blur-up lazyload" data-src="/assets/images/products/cart-electronic-product-img2.jpg" src="/assets/images/products/cart-electronic-product-img2.jpg" alt="product" title="Product" width="120" height="170" />
                                </a>
                                <div class="product-details">
