                            ...
                            <div class="row">
                                    ...
                                    <div id="quickView" class="carousel slide">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item carousel-item active" data-bs-slide-number="0">
                                                <img class="blur-up lazyload" data-src="/assets/images/products/electronic-product1.jpg" src="/assets/images/products/electronic-product1.jpg" alt="product" title="Product" width="625" height="625" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="1">
                                                <img class="blur-up lazyload" data-src="/assets/images/products/electronic-product2.jpg" src="/assets/images/products/electronic-product2.jpg" alt="product" title="Product" width="625" height="625" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="2">
                                                <img class="blur-up lazyload" data-src="/assets/images/products/electronic-product3.jpg" src="/assets/images/products/electronic-product3.jpg" alt="product" title="Product" width="625" height="625" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="3">
                                                <img class="blur-up lazyload" data-src="/assets/images/products/electronic-product4.jpg" src="/assets/images/products/electronic-product4.jpg" alt="product" title="Product" width="625" height="625" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="4">
                                                <img class="blur-up lazyload" data-src="/assets/images/products/electronic-product5.jpg" src="/assets/images/products/electronic-product5.jpg" alt="product" title="Product" width="625" height="625" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="5">
                                                <img class="blur-up lazyload" data-src="/assets/images/products/electronic-product6.jpg" src="/assets/images/products/electronic-product6.jpg" alt="product" title="Product" width="625" height="625" />
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="product-info">
                                        <p class="product-vendor">Vendor:<span class="text"><a href="#">Electronic</a></span></p>  
                                        ...
                                        <div class="product-options d-flex-wrap">
                                            ...
                                            <div class="product-action d-flex-wrap w-100 pt-1 mb-3 clearfix">
                                                ...
                                                <div class="addtocart ms-3 fl-1">
                                                    <button type="submit" name="add" class="btn btn-primary product-cart-submit w-100"><i class="icon anm anm-basket-l me-2"></i><span>Add to cart</span></button>
